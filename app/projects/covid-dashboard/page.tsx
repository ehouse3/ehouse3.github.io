  ...
  return (
    <div>
      ...
      <section data-desc="challenges" className="my-5">
        ...
        <p>
          This was a feature I knew I wanted to implement, as it presented a fun
          computer science problem. Computing a rolling 7-day average on the fly
          without tanking performance was a major concern. I found two solutions
          and ultimately chose to evaluate the average at runtime. On one hand,
          preprocessing the data would reduce client computation. On the other,
          the pandemic has ended, making the data generally fixed, and over a
          2-year period it would result in fewer than 750 data points. This felt
          like an acceptable range of values to compute at runtime, and I thus
          decided to process the data on the client side of the application.
        </p>
        <p>
          The solution was a sliding window algorithm. Simply slide through the
          data, find the average of the current 7 nodes, and output. Then
        ...
        <p>
          ...
          entirely blank. This inconsistency was a real problem. My solution was
          to pre-calculate which metrics were empty and visually display the
          metric crossed out in the dashboard. The pipeline of detecting empty
          metrics to applying the appropriate style changes turned out to be
      ...
      <section data-desc="details" className="my-5">
        ...
        <p>
          Next.js provided a solution to a general problem I had encountered in
          the past. My app needed file organization with libraries and configs,
          especially since I didn&apos;t know, at the time, what the future held
          for this project. Going overboard with a larger system felt better
          than regretting a lack of structure later.
        </p>
        <p>
          A major realization after the fact was that I didn&apos;t interact
          with many of the features Next.js had to offer. There was no need for
          dynamic routes, no prefabricated images requiring optimization, no
          multi-page layout, and server-side rendering wasn&apos;t needed either
          as it would have driven up hosting costs. This wasn&apos;t the project
          for Next.js to shine, but it did play a pivotal part in the general
          organization of the app. I intended to carry some of these lessons I
        ...
        <div>
          <h5>Tailwind CSS</h5>
          <p>
            Tailwind, in my opinion, had the largest impacts on this project and
